        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 rounded-full bg-accent px-8 py-4 text-lg font-semibold text-white hover:bg-accent-dark transition-colors shadow-lg hover:shadow-xl"
            >
